...
if (markHigherBMI)
  console.log(
    `Mark's BMI(${Mark.getBMI().toFixed(
      1
    )}) is higher than John's BMI (${John.getBM().toFixed(1)})!`
  );
else
  console.log(
    `John's BMI(${John.getBMI().toFixed(
      1
    )}) is higher than Marks's BMI(${Mark.getBMI().toFixed(1)})!`
  );
...
if (markHigherBMI)
  console.log(
    `Mark's BMI(${Mark.getBMI().toFixed(
      1
    )}) is higher than John's BMI (${John.getBMI().toFixed(1)})!`
  );
else
  console.log(
    `John's BMI(${John.getBMI().toFixed(
